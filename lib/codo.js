(function() {
  ...
  exports.run = function() {
    var arg, args, argv, bool, codoopts, config, configs, extra, filename, input, optimist, option, options, parser, _i, _j, _k, _len, _len2, _len3, _ref, _ref2, _results;
    codoopts = {
      _: []
    };
    try {
          ...
          _results.push((function() {
            ...
            for (_l = 0, _len4 = _ref3.length; _l < _len4; _l++) {
              ...
              if (filename.match(/\.coffee$/)) {
                try {
                  _results2.push(parser.parseFile(filename));
                } catch (error) {
                  _results2.push(console.log("Cannot parse file " + filename + ": " + error.message));
                }
              } else {
