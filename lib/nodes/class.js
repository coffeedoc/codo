(function() {
  ...
  module.exports = Class = (function() {
    ...
    function Class(node, fileName, options, comment) {
      var doc, exp, previousExp, previousProp, prop, _i, _j, _len, _len2, _ref, _ref2, _ref3;
      this.node = node;
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        switch (exp.constructor.name) {
          case 'Assign':
            ...
            this.variables.push(new Variable(exp, this.options, true, doc));
            doc = null;
            break;
          case 'Value':
            previousProp = null;
            ...
            for (_j = 0, _len2 = _ref2.length; _j < _len2; _j++) {
              ...
              switch ((_ref3 = prop.value) != null ? _ref3.constructor.name : void 0) {
                case 'Code':
                  ...
                  this.methods.push(new Method(prop, this.options, doc));
                  doc = null;
                  break;
                case 'Value':
                  this.variables.push(new Variable(prop, this.options));
              }
              previousProp = prop;
            }
        }
