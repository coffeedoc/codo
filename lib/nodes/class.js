(function() {
  ...
  module.exports = Class = (function(_super) {
    ...
    function Class(node, fileName, options, comment) {
      var doc, exp, method, previousExp, previousProp, prop, _i, _j, _k, _len, _len2, _len3, _ref, _ref2, _ref3, _ref4, _ref5, _ref6;
      this.node = node;
      ...
      try {
        ...
        if (this.doc.methods) {
          _ref2 = (_ref = this.doc) != null ? _ref.methods : void 0;
        ...
        previousExp = null;
        _ref3 = this.node.body.expressions;
        for (_j = 0, _len2 = _ref3.length; _j < _len2; _j++) {
          ...
          switch (exp.constructor.name) {
            case 'Assign':
              ...
              switch ((_ref4 = exp.value) != null ? _ref4.constructor.name : void 0) {
                case 'Code':
            ...
            case 'Value':
              previousProp = null;
              _ref5 = exp.base.properties;
              for (_k = 0, _len3 = _ref5.length; _k < _len3; _k++) {
                prop = _ref5[_k];
                if ((previousProp != null ? previousProp.constructor.name : void 0) === 'Comment') {
                  doc = previousProp;
                }
                switch ((_ref6 = prop.value) != null ? _ref6.constructor.name : void 0) {
                  case 'Code':
    ...
    Class.prototype.getClassName = function() {
      var outer, prop, _i, _j, _len, _len2, _ref, _ref2;
      try {
        if (!this.className) {
          ...
          _ref2 = this.node.variable.properties;
      ...
      try {
        if (!this.parentClassName) {
          if (this.node.parent) {
            ...
            _ref2 = this.node.parent.properties;
            for (_j = 0, _len2 = _ref2.length; _j < _len2; _j++) {
              prop = _ref2[_j];
              this.parentClassName += "." + prop.name.value;
            }
    ...
    Class.prototype.getMethods = function() {
      ...
      if (this.options.private) {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          method = _ref[_i];
          if (!method.doc.private) _results.push(method);
        }
        return _results;
      }
    };
