(function() {
  ...
  module.exports = Mixin = (function(_super) {
    ...
    function Mixin(node, fileName, options, comment) {
      var doc, exp, method, previousExp, _i, _j, _k, _len, _len1, _len2, _ref, _ref1, _ref2, _ref3, _ref4;
      this.node = node;
      ...
      try {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          ...
          if (exp.constructor.name === 'Assign') {
            ...
            if (((_ref1 = exp.value) != null ? _ref1.constructor.name : void 0) === 'Code') {
              this.methods.push(new Method(this, exp, this.options, doc));
            }
            if (((_ref2 = exp.value) != null ? _ref2.constructor.name : void 0) === 'Value') {
        ...
        if ((this.classMixin != null) && (this.instanceMixin != null)) {
          this.concern = true;
          _ref3 = this.classMixin.getMethods();
          for (_j = 0, _len1 = _ref3.length; _j < _len1; _j++) {
            method = _ref3[_j];
            method.type = 'class';
            this.methods.push(method);
          }
          _ref4 = this.instanceMixin.getMethods();
