(function() {
  ...
  module.exports = Doc = (function() {
    ...
    function Doc(node, options) {
      var abstract, author, code, comment, deprecated, example, line, lines, module, note, option, param, returnValue, see, since, text, title, todo, version, _base, _name, _ref;
      this.node = node;
