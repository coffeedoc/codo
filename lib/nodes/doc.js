(function() {
  ...
  module.exports = Doc = (function() {
    ...
    function Doc(node, clazz, options) {
      var abstract, author, code, comment, copyright, deprecated, example, line, lines, note, option, param, returnValue, see, since, text, title, todo, version, _base, _name, _ref;
      this.node = node;
      this.clazz = clazz;
