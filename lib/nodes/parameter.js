(function() {
  ...
  module.exports = Parameter = (function() {
    ...
    Parameter.prototype.getDefault = function() {
      ...
      try {
        if (((_ref = this.node.value) != null ? _ref.base.value : void 0) === 'this') {
          return "@" + ((_ref2 = this.node.value.properties[0]) != null ? _ref2.name.value : void 0);
        } else {
          return (_ref3 = this.node.value) != null ? _ref3.compile({
            indent: ''
          }) : void 0;
        }
      } catch (error) {
