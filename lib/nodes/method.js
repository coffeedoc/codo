(function() {
  ...
  module.exports = Method = (function() {
    ...
    function Method(node, options, comment) {
    ...
    Method.prototype.getSignature = function() {
      ...
      if (!this.signature) {
        ...
        if (this.getDoc()) {
          this.signature += this.getDoc().returnValue ? "(" + (this.getDoc().returnValue.type) + ") " : "(void) ";
        }
        ...
        this.signature += ')';
        if (this.getDoc()) {
          this.signature += this.getDoc().private ? ' (private)' : '';
        }
      }
