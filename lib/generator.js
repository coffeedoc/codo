(function() {
  ...
  module.exports = Generator = (function() {
    ...
    function Generator(parser, options) {
      ...
      this.referencer = new Referencer(this.parser.classes, this.parser.modules, this.options);
    ...
    Generator.prototype.generate = function() {
      ...
      this.generateFiles();
      this.generateClassAndModuleIndex();
      this.generateClassAndModuleLists();
    ...
    Generator.prototype.generateClassAndModuleIndex = function() {
    ...
    Generator.prototype.generateClassAndModuleLists = function() {
      var classes, clazz, module, modules, traverse, _i, _j, _len, _len2, _ref, _ref2;
      classes = [];
      modules = [];
