(function() {
  ...
  module.exports = Generator = (function() {
    ...
    Generator.prototype.generateSearchData = function() {
      var clazz, file, mixin, search, _i, _j, _k, _len, _len2, _len3, _ref, _ref2, _ref3;
      search = [];
      _ref = this.parser.classes;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        clazz = _ref[_i];
        search.push({
          ...
          methods: _.map(clazz.getMethods(), function(m) {
            return m.getShortSignature();
          })
        });
      }
      _ref2 = this.parser.mixins;
      ...
      _ref3 = _.union([this.options.readme], this.options.extras.sort());
