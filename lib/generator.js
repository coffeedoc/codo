(function() {
  ...
  module.exports = Generator = (function() {
    ...
    Generator.prototype.generateFiles = function() {
      var assetPath, content, extra, filename, numSlashes, slash, _i, _len, _ref, _results;
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        try {
          ...
          assetPath = '';
          for (slash = 0; 0 <= numSlashes ? slash < numSlashes : slash > numSlashes; 0 <= numSlashes ? slash++ : slash--) {
            assetPath += '../';
          }
          filename = "" + extra + ".html";
    ...
    Generator.prototype.generateSearchData = function() {
      var clazz, file, method, mixin, search, _i, _j, _k, _l, _len, _len2, _len3, _len4, _len5, _m, _ref, _ref2, _ref3, _ref4, _ref5;
      search = [];
      _ref = this.parser.classes;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        clazz = _ref[_i];
      ...
      _ref5 = _.union([this.options.readme], this.options.extras.sort());
      ...
      return fs.writeFile("" + this.options.output + "/assets/search_data.js", 'window.searchData = ' + JSON.stringify(search), function(err) {
        if (err) return console.error("[ERROR] Cannot write search data: ", err);
      });
    };
