(function() {
  ...
  module.exports = Generator = (function() {
    ...
    Generator.prototype.generateFiles = function() {
      var assetPath, content, extra, filename, numSlashes, slash, _i, _j, _len, _ref, _results;
    ...
    Generator.prototype.generateSearchData = function() {
      var clazz, destinationFolder, file, method, mixin, search, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _m, _ref, _ref1, _ref2, _ref3, _ref4;
      search = [];
      _ref = this.parser.classes;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        clazz = _ref[_i];
      ...
      destinationFolder = "" + this.options.output + "/assets";
      return mkdirp(destinationFolder, function(err) {
        if (err) {
          return console.error("[ERROR] Cannot create directory " + dir + ": " + err);
        } else {
          return fs.writeFile("" + destinationFolder + "/search_data.js", 'window.searchData = ' + JSON.stringify(search), function(err) {
            if (err) {
