  ...
  module.exports = Parser = (function() {
    ...
    Parser.prototype.parseContent = function(content, file) {
      ...
      entities = {
        ...
        mixin: function(node) {
          var _ref, _ref2;
          return node.constructor.name === 'Assign' && (((_ref = node.value) != null ? (_ref2 = _ref.base) != null ? _ref2.properties : void 0 : void 0) != null);
        }
      };
      root = CoffeeScript.nodes(this.convertComments(content));
      this.linkAncestors(root);
      root.traverseChildren(true, function(child) {
        var clazz, condition, doc, entity, mixin, name, node, p, previous, type, _i, _len, _ref, _ref2;
        entity = false;
    ...
    Parser.prototype.getAllVariables = function() {
      var clazz, mixin, _i, _j, _len, _len2, _ref, _ref2;
    ...
    Parser.prototype.toJSON = function() {
      var clazz, json, mixin, _i, _j, _len, _len2, _ref, _ref2;
      json = [];
      _ref = this.classes;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        clazz = _ref[_i];
