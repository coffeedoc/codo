          ...
          for (_j = 0, _len2 = _ref.length; _j < _len2; _j++) {
            ...
            if (method.getDoc() && !_.isEmpty(method.getDoc().params)) {
              _results2.push((function() {
                var _base, _base2, _base3, _k, _len3, _ref2, _results3;
                      ...
                      if (param.name) {
                        ...
                        if (copyParam) {
                          ...
                          if (_.isObject(refMethod.getDoc().paramsOptions)) {
                            ...
                            _results3.push(method.getDoc().paramsOptions[param.name] = refMethod.getDoc().paramsOptions[param.name]);
                          } else {
                        ...
                        if (_.isObject(refMethod.getDoc().paramsOptions)) {
                          (_base3 = method.getDoc()).paramsOptions || (_base3.paramsOptions = {});
                          _results3.push((function() {
                            var _l, _len4, _results4;
                            _results4 = [];
                            for (_l = 0, _len4 = names.length; _l < _len4; _l++) {
                              name = names[_l];
                              _results4.push(method.getDoc().paramsOptions[name] = refMethod.getDoc().paramsOptions[name]);
                            }
                            return _results4;
                          })());
                        } else {
