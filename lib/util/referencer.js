(function() {
  ...
  module.exports = Referencer = (function() {
    ...
    Referencer.prototype.resolveDoc = function(data, clazz, path) {
      var example, index, name, note, option, options, param, see, todo, _i, _len, _len2, _len3, _len4, _len5, _ref, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8;
      ...
      _ref4 = data.doc.params;
      for (name in _ref4) {
        param = _ref4[name];
        data.doc.params[name].desc = this.resolveTextReferences(param.desc, clazz, path);
      }
      if (data.doc.notes) {
        _ref5 = data.doc.notes;
        for (index = 0, _len3 = _ref5.length; index < _len3; index++) {
          note = _ref5[index];
          data.doc.notes[index] = this.resolveTextReferences(note, clazz, path);
        }
      }
      if (data.doc.todos) {
        _ref6 = data.doc.todos;
        for (index = 0, _len4 = _ref6.length; index < _len4; index++) {
          todo = _ref6[index];
          data.doc.todos[index] = this.resolveTextReferences(todo, clazz, path);
        }
      }
      if (data.doc.examples) {
        _ref7 = data.doc.examples;
        for (index = 0, _len5 = _ref7.length; index < _len5; index++) {
          example = _ref7[index];
      ...
      if ((_ref8 = data.doc.returnValue) != null ? _ref8.desc : void 0) {
